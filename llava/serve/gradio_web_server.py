...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="Consenko Image Inference", theme=gr.themes.Default(), css=block_css) as demo:
        state = gr.State()
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/examples/extreme_ironing.jpeg", "What is unusual about this image?"],
                    [f"{cur_dir}/examples/waterview.jpeg", "What is this image about and what are the things I should be cautious about when I visit here ?"],
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(elem_id="chatbot", label="Consenko Chatbot", height=550)
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
